...
let lastCar = 0;
//note I don't know why lastCar is set to 0 rather than inventory.length-1 but gonna leave it as default I guess?
...
let oldCars =[];
oldCars = inventory.map(car => car.car_year);
oldCars = oldCars.filter(car_year => car_year < 2000);
